...
class PersonaSerializer(serializers.Serializer):
    ...
    #En el caso de querer agregar un campo que pueda o no estar en el modelo agregar este atributo "required":
...
class PersonPagination(pagination.PageNumberPagination):
    page_size = 5 #en bloques de a cuanto se visualizan
    max_page_size = 100 #cuantos carga en memoria
